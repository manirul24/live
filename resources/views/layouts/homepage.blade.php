...
<head>
      <title>{{ config('app.name', 'NU') }}</title>

    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <link rel="stylesheet" href="{{ asset('css/bootstrap/bootstrap.min.css') }}">
    <link rel="icon" type="{{ asset('image/png') }}" sizes="32x32" href="shuffle-for-bootstrap.png">
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="nav06">
            <ul class="navbar-nav mt-3 mt-lg-0 mb-3 mb-lg-0 ms-lg-3">
              ...
              <li class="nav-item me-4"><a class="nav-link" href="{{ route('register') }}">register</a></li>
